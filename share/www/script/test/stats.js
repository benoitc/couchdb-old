...
//   if (debug) debugger;
  ...
  //        db.deleteDb();
  //        var open_databases = parseInt(CouchDB.requestStats("couchdb", "open_databases").count);
  //        db.createDb();
  //    
  //        var new_open_databases = parseInt(CouchDB.requestStats("couchdb", "open_databases").count);
 ...
 //       var requests = CouchDB.requestStats("httpd", "requests").count + 1;
 // 
 //       CouchDB.request("GET", "/");
 // 
 //       var new_requests = CouchDB.requestStats("httpd", "requests").count;
